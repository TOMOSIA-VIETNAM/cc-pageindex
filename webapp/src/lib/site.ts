...
// Who publishes the project: named in the author meta, Open Graph's site data and the
// structured data, never in the page title.
export const ORGANIZATION = { name: "TOMOSIA VIETNAM", url: "https://tomosia.com" };

// The brand mark; scripts/build-icons.mjs renders the PNG icons from it.
export const MARK_PATH = "public/icon/favicon.svg";
